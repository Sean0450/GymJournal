  ...
  : QDialog(parent)
{
  ...
  connect(m_exerciseNameEdit, &QLineEdit::textChanged, this, &AddExerciseDialog::ExerciseNameEditChanged);
  ...
  connect(m_musculesGroupNameEdit, &QLineEdit::textChanged, this, &AddExerciseDialog::MusculesGroupEditChanged);
  secondHLayout->addWidget(m_musculesGroupNameEdit);
  vlayout->addLayout(secondHLayout);

  m_addButton = new QPushButton(this);
  connect(m_addButton, &QPushButton::clicked, this, &AddExerciseDialog::AddButtonClicked);
